...
2. Level 5* cards to 60/60 and 4* cards to 50/50.Focus on your main’s primary and secondary colours [|list in table]. Do not level any 3* cards unless you are doing so for affinity. 
...
3. If you want to main one of the OG3, you won’t necessarily need a secondary but having one can be convenient. Try to limit levelling second LI's cards to those that do not overlap with your main’s stella coverage.
